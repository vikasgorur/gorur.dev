...
SECRET = "ZV DL ILHA VU IVHAZ HNHPUZA AOL JBYYLUA IVYUL IHJR JLHZLSLZZSF PUAV AOL WHZA"
...
$$
entropy = \sum_{x_i} P(x_i) \space log_2 \frac{1}{P(x_i)}
$$
...
plt.scatter(range(26), distances, marker='x', s=50)  # Changed marker to 'x' and added size parameter
plt.scatter(7, distances[7], marker='x', s=50, color=(0.92, 0.41, 0.39))
...
plt.title('(1 / distance) between decrypted text and English for each key')
plt.xticks(range(26))
