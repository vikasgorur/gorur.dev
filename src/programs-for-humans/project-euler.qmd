    ...
    include-in-header: |
      ...
      <script>
        document.addEventListener('DOMContentLoaded', function() {
          ...
          tocActions.appendChild(showAllBtn);
          tocActions.appendChild(hideAllBtn);
          
          // Insert TOC actions after the TOC
          const toc = document.querySelector('#TOC');
          toc.parentNode.insertBefore(tocActions, toc.nextSibling);
