...
See [@hayes2013] for a fascinating history of how he analyzed the text of
...
@shannon1948 defined the concepts of entropy and cross-entropy. The cross-entropy
...
@bengio2003 (Turing Award 2018) first used neural networks for language
...
See @karpathy2015 on their "unreasonable effectiveness".
